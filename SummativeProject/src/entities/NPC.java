...
public class NPC extends Character {
    public NPC(Animation up, Animation down, Animation left, Animation right,
    ...
    public NPC(String pathName, int [] duration, float x, float y, float colxOffset, float colyOffset, float colWidth, float colHeight, CharacterStats stats) throws SlickException {
